 ...
 * \file
 *
 * \brief User board definition file
 *
 */
 ...
 *  @{ */
#define TCXO_PWR_PIN				PIN_PA18
#define TCXO_PWR_ACTIVE             true
#define TCXO_PWR_INACTIVE	        !TCXO_PWR_ACTIVE
/** @} */

/** \name CPS Pin definitions
 *  @{ */
#define CPS_PIN						PIN_PA27
#define CPS_ACTIVE					true
#define CPS_INACTIVE				!CPS_ACTIVE
/** @} */

/** \name CSD Pin definitions
 *  @{ */
#define CSD_PIN						PIN_PA13
#define CSD_ACTIVE					true
#define CSD_INACTIVE				!CSD_ACTIVE
/** @} */
